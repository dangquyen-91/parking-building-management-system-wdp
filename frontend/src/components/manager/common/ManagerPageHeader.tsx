...
export function ManagerPageHeader({
  ...
  return (
    <Card className="mb-6 overflow-hidden border-emerald-500/20 bg-linear-to-br from-white via-sky-50/70 to-emerald-50/70 shadow-sm dark:from-slate-950 dark:via-sky-950/25 dark:to-emerald-950/20">
      <CardContent className="p-5 md:p-7">
        <div className="flex flex-col gap-5 xl:flex-row xl:items-end xl:justify-between">
          <div className="min-w-0">
            ...
            <h1 className="max-w-4xl wrap-break-word text-3xl font-semibold tracking-tight text-slate-950 md:text-4xl dark:text-white">{title}</h1>
