...
import { ManagerBookingDetailsDialog } from './ManagerBookingDetailsDialog'
  ...
  return (
    <ManagerTableShell
      ...
      columns={[
        ...
        { label: 'Khách hàng', className: 'w-[18%]' },
        { label: 'Thời gian đến', className: 'w-[17%]' },
        { label: 'Thời gian rời', className: 'w-[17%]' },
        { label: 'Số tiền', className: 'w-[13%]' },
