...
export const operationInputClass =
  'border-input bg-transparent h-9 w-full min-w-0 rounded-md border px-3 py-1 text-sm shadow-xs outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px]'
...
export function OperationListShell({
  eyebrow,
  title,
  count,
  children,
...
export function OperationInfoCell({
  label,
  value,
  detail,
  strong = false,
