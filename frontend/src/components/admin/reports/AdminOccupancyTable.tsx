  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardTitle>Tình trạng theo tầng</CardTitle>
      </CardHeader>
      <CardContent>
        {!floors.length ? (
            ...
            <Table className="min-w-[720px] text-left">
              <TableHeader className="bg-muted/50 text-xs">
                <TableRow className="hover:bg-transparent">
                  <TableHead className="h-auto px-3 py-3">
                    Tòa nhà / Tầng / Khu
                  </TableHead>
              ...
              <TableBody>
                {floors.map((floor) => (
                  <TableRow key={floor.floorId}>
                    ...
                    <TableCell className="px-3 py-3 font-bold text-foreground">
                      {floor.occupied}
                    </TableCell>
                    <TableCell className="px-3 py-3 text-muted-foreground">
                      {floor.empty}
