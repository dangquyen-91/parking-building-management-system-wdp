...
export function AdminPageShell({
  ...
  return (
    <div className="relative mx-auto max-w-[118rem] p-4 md:p-6 lg:p-8">
      <Card className="relative mb-6 overflow-hidden border-violet-500/20 bg-linear-to-br from-white via-violet-50/70 to-sky-50/70 shadow-sm dark:from-slate-950 dark:via-violet-950/25 dark:to-sky-950/20">
        <div className="pointer-events-none absolute inset-y-0 left-0 w-1 bg-linear-to-b from-violet-500 via-sky-500 to-emerald-500" />
        ...
        <CardContent className="relative p-5 md:p-6">
          <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
            <div className="min-w-0">
              ...
              <h1 className="max-w-4xl wrap-break-word text-2xl font-bold tracking-tight text-slate-950 md:text-3xl dark:text-white">
                {title}
              </h1>
